...
function plotImageSources(roomDimensions, receiverCoord, sourceCoord, isourceCoord, RaytraceOn, axis)
...
scatter3(axis, isourceCoord(:, 1), isourceCoord(:, 2), isourceCoord(:, 3), 'r', 'filled');

% Connect isourceCoord to receiverCoord if RaytraceOn is true
if RaytraceOn
    for i = 1:size(isourceCoord, 1)
        plot3(axis, [receiverCoord(1), isourceCoord(i, 1)], ...
